...
echo "><br><i>$sciname</i></span><br>
  ...
  while($results=$result2->fetchArray(SQLITE3_ASSOC))
  {
    ...
    if ($num_rows < 100) {
        $imageelem = "<div class='spectrogram-container' style='position: relative; display: inline-block; width: 100%;'><img src='$filename_png' alt='$filename' style='width: 100%; border-radius: 10px;'>
...
<div class='spectrogram-container' style='position: relative; display: inline-block; width: 100%;'>
    <img src='$filename_png' alt='$filename' style='width: 100%; border-radius: 10px;'>
