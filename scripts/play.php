...
<div style="width: auto;
   ...
   <form action="views.php" method="GET">
      ...
      <br><br><label style="cursor: pointer; font-weight: normal; display: inline-flex; align-items: center; justify-content: center;">
...
<div style="width: auto;
   ...
   <form action="views.php" method="GET">
      ...
      <br><label style="cursor: pointer; margin-top: 10px; margin-bottom: 10px;font-weight: normal; display: inline-flex; align-items: center; justify-content: center;">
      <input type="checkbox" name="only_excluded" <?= isset($_GET['only_excluded']) ? 'checked' : '' ?> onchange="submit()" style="display:none;">
      <span style="width: 40px; height: 20px; background: #ccc; border-radius: 20px; display: inline-block; position: relative; margin-right: 8px;">
      <span style="width: 16px; height: 16px; background: white; border-radius: 50%; position: absolute; top: 2px; left: 2px; transition: 0.4s; <?= isset($_GET['only_excluded']) ? 'transform: translateX(20px);' : '' ?>">		
