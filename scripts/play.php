...
<label style="cursor: pointer; margin-top: 10px; margin-bottom: 10px; font-weight: normal; display: inline-flex; align-items: center; justify-content: center;">
  ...
  <span style="width: 40px; height: 20px; background: <?= isset($_GET['only_confirmed']) ? '#555555' : 'rgba(85, 85, 85, 0.9)' ?>; border: 1px solid white; border-radius: 20px; display: inline-block; position: relative; margin-right: 8px; transition: background 0.4s, border 0.4s; box-sizing: border-box;">
    <span style="width: 16px; height: 16px; background: white; border-radius: 50%; position: absolute; top: 1px; left: 2px; transition: 0.4s; display: flex; align-items: center; justify-content: center; font-size: 14px; color: black; <?= isset($_GET['only_confirmed']) ? 'transform: translateX(20px);' : '' ?>">
