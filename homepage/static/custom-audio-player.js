function initCustomAudioPlayers() {
  ...
  const icons = {
    ...
    dots: `<svg width="24" height="24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M12 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM12 22a2 2 0 1 0 0-4 2 2 0 0 0 0[...]
  };
  ...
  document.querySelectorAll(".custom-audio-player").forEach(player => {
    ...
    audioEl.preload = "none"; // Prevent preloading
